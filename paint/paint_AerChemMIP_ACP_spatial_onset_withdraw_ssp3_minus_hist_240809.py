...
im = ax.pcolormesh(f0.lon.data, f0.lat.data, 1*(five_points_smoother((f0['withdraw_ssp3'].data - f1['onset_ssp3'].data) - (f0['withdraw_hist'].data - f1['onset_hist'].data))), cmap=newcmp, vmin=-15, vmax=15)
