...
if __name__ == '__main__':
    f0  =  xr.open_dataset('/home/sun/data/AerChemMIP/process/multiple_model_climate_wap_month_MJJAS.nc').sel(plev=50000)
    ...
    plot_change_wet_day(np.nanmean(ssp0, axis=0) * 1e3, np.nanmean(ntcf0, axis=0) * 1e3, '500hPa OMEGA (group2)', '500hPa OMEGA (group2)', f0.lon.data, f0.lat.data, ttest, levels)