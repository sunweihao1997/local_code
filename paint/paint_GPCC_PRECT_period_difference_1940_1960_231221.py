...
#    sp  =  ax.contourf(lon, lat, p, levels=[0.1, 1], colors='none', hatches=['..'])
    ...
    # --- title ---
    ax.set_title('GPCC', loc='left', fontsize=17.5)
    ax.set_title(title_name, loc='right', fontsize=17.5)
...
#
def main():
    paint_trend(lat=lat, lon=lon, diff=diff_precip_JJAS, level=np.linspace(-2.75, 2.75, 23), p=None, title_name='JJAS', pic_path='/home/sun/paint/aerosol_reasearch/', pic_name="Aerosol_Research_GPCC_PRECT_JJAS_period_diff_1900_1960.pdf")
    paint_trend(lat=lat, lon=lon, diff=diff_precip_JJA, level=np.linspace(-2.75, 2.75, 23), p=None, title_name='JJA', pic_path='/home/sun/paint/aerosol_reasearch/', pic_name="Aerosol_Research_GPCC_PRECT_JJA_period_diff_1900_1960.pdf")
##
