...
gpcc      = f0['gpcc_filter'].data - np.average(f0['gpcc_filter'].data)
cesm      = f0['cesm_filter'].data - np.average(f0['cesm_filter'].data)

# ============== paint ==========================================

fig, ax = plt.subplots(figsize=(12,18))

ax.plot(np.linspace(1900, 2000, 101), gpcc, color='black')
ax.plot(np.linspace(1900, 2000, 101), cesm, color='red')
