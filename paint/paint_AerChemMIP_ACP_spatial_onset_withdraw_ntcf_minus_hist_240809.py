...
im = ax.pcolormesh(f0.lon.data, f0.lat.data, 1*(five_points_smoother((f0['withdraw_ntcf'].data - f1['onset_ntcf'].data) - (f0['withdraw_hist'].data - f1['onset_hist'].data))), cmap=newcmp, vmin=-15, vmax=15)
