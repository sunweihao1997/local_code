...
f0  =  xr.open_dataset('/home/sun/data/process/analysis/AerChem/modelmean_onset_day_threshold4.nc')
...
im = ax.pcolormesh(f0.lon.data, f0.lat.data, 1.1*(f0['onset_ssp3'].data - f0['onset_ntcf'].data), cmap=newcmp, vmin=-15, vmax=15)
...
plt.savefig('/home/sun/paint/AerMIP/test_onset_Bingwang_diff_threshold4.png')
