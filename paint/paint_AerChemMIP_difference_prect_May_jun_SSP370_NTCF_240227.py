...
data_path = '/Volumes/Untitled/AerChemMIP/post_process_samegrids/'
ssp370_f  = 'CMIP6_model_SSP370_monthly_precipitation_1985-2014.nc'
sspntcf_f = 'CMIP6_model_SSP370NTCF_monthly_precipitation_1985-2014.nc'
...
def paint_pentad_circulation(prect):
...
def main():
    ...
    paint_pentad_circulation(prect0)
