...
path_src = '/data/AerChemMIP/process/post-process/rsds_samegrid/'
...
#        
        ...
        dataset_allmodel.to_netcdf('/data/AerChemMIP/process/multiple_model_climate_rsds_month_MJJAS.nc')
